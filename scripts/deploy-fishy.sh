...
echo "Building MoonBit fishy CLI..."
moon build cli/fishy --target native -q

BUILD_DIR="${ROOT_DIR}/_build/native/release/build/cli/fishy"
SOURCE_BIN="${BUILD_DIR}/fishy.exe"

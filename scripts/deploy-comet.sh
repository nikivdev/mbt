...
echo "Building MoonBit comet CLI..."
moon build cli/comet --target native -q

BUILD_DIR="${ROOT_DIR}/_build/native/release/build/cli/comet"
SOURCE_BIN="${BUILD_DIR}/comet.exe"

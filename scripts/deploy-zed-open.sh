...
echo "Building MoonBit zed-open CLI..."
moon build cli/zed-open --target native -q

BUILD_DIR="${ROOT_DIR}/_build/native/release/build/cli/zed-open"
SOURCE_BIN="${BUILD_DIR}/zed-open.exe"
